...
<center><img src="BKash.jpg" width=88%></center>
	    ...
	    <form action="feedback.php" method="post" class="agile_form">
		  <h2>select the amount to pay</h2>
			 ...
			 <ul class="agile_info_select">
				 <li><input type="radio" name="view" value="Tk 200" id="Rs 200" required> 
				 	  <label for="Rs 200">Tk 200</label>
				      <div class="check w3"></div>
				 </li>
				 <li><input type="radio" name="view" value="Tk 800" id="Rs 800"> 
					  <label for="Rs 800"> Tk 800</label>
				      <div class="check w3ls"></div>
				 </li>
				 <li><input type="radio" name="view" value="Tk 1000" id="Rs 1000"> 
					  <label for="Rs 1000"> Tk 1000</label>
				      <div class="check w3ls"></div>
				 </li>
